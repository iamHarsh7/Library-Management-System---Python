...
def addBook(): 
    ...
    # conn = mysql.connector.connect(user='root', password='@Shsv0601@' , database = 'lpu' , auth_plugin='mysql_native_password')
    # c = conn.cursor()
    ...
    headingLabel = Label(headingFrame1, text="Add Books", bg='black', fg='yellow', font=('times new roman',22))
